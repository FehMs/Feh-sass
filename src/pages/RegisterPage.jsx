      ...
      <div className="login-container">
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          <div className="input-container">
            <label>
              <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.6673 16.5V14.8333C14.6673 13.9493 14.3161 13.1014 13.691 12.4764C13.0659 11.8512 12.218 11.5 11.334 11.5H4.66731C3.78326 11.5 2.93541 11.8512 2.31029 12.4764C1.68517 13.1014 1.33398 13.9493 1.33398 14.8333V16.5" stroke="white" stroke-width="2.35294" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.99936 8.16667C9.84025 8.16667 11.3327 6.67428 11.3327 4.83333C11.3327 2.99239 9.84025 1.5 7.99936 1.5C6.1584 1.5 4.66602 2.99239 4.66602 4.83333C4.66602 6.67428 6.1584 8.16667 7.99936 8.16667Z" stroke="white" stroke-width="2.35294" stroke-linecap="round" stroke-linejoin="round"/></svg>
              <input
                type="email"
                value={email}
